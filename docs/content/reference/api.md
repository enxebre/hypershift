...
<td>
<em>(Optional)</em>
<p>availabilityZone is the failure domain identifier where the VM should be attached to.
This must not be specified for clusters in a location that does not support AvailabilityZone because&hellip; TODO: why?
Availability zones are identified by numbers, either 1, 2 or 3.</p>
</td>
</tr>
<tr>
<td>
