...
<tr>
<td>
<code>oidcAuth</code></br>
<em>
<a href="#hypershift.openshift.io/v1beta1.OIDCAuth">
OIDCAuth
</a>
</em>
</td>
<td>
<p>OIDCAuth contains the input to setup the kube api server to authenticate via an external OIDC provider.</p>
</td>
</tr>
<tr>
<td>
...
###OIDCAuth { #hypershift.openshift.io/v1beta1.OIDCAuth }
<p>
(<em>Appears on:</em>
<a href="#hypershift.openshift.io/v1beta1.HostedClusterSpec">HostedClusterSpec</a>, 
<a href="#hypershift.openshift.io/v1beta1.HostedControlPlaneSpec">HostedControlPlaneSpec</a>)
